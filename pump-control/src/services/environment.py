...
class env:
    ...
    def load_definitions(self) -> None:
        ...
        # Credentials
        self.ORBIT_USERNAME = None
        self.ORBIT_PASSWORD = None
        # Shelly Pro1PM
        self.SHELLY_PRO_1PM_HOST = None
        self.SHELLY_PRO_1PM_FAILSAFE_SECONDS = None
        ...
        self.definitions = [
            ...
            # Shelly Pro1PM
            {
                "name" : "SHELLY_PRO_1PM_HOST",
                "required" : True,
                "default" : "",
                "type" : "str"
            },
                        {
                "name" : "SHELLY_PRO_1PM_FAILSAFE_SECONDS",
                "required" : False,
                "default" : 10,
                "type" : "int"
            }
